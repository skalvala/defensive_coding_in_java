...
public class OptionalDemo {
    ...
    public static void main(String[] args){
        ...
        // (2)
        earliestFlight.ifPresent(x -> System.out.println("Flight found: " + earliestFlight));

        // to fix: earliestFlight.orElse(System.out.println("Didn't find any flights for your search"));
